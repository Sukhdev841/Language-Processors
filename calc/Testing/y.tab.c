...
{
  "$end", "error", "$undefined", "number", "sem", "per1", "per2", "per3",
  "per4", "$accept", "lines", "line", "exp", "factor2", "factor3",
  "factor4", "factor5", YY_NULLPTR
};
#endif
...
{
       0,    13,     0,     2,     0,     5,     7,     9,    11,     1,
       3,     4,     0,     0,     0,     0,     6,     8,    10,    12
};
...
{
       9,    11,    12,     1,     1,    13,    15,    10,    16,    14,
      19,     0,     0,     0,     0,     0,    17,     0,    18
};

static const yytype_int8 yycheck[] =
{
       0,     4,     5,     3,     3,     6,     8,     2,    12,     7,
      15,    -1,    -1,    -1,    -1,    -1,    13,    -1,    14
};
...
{
       0,     3,    10,    11,    12,    13,    14,    15,    16,     0,
      11,     4,     5,     6,     7,     8,    13,    14,    15,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 23 "calcy.y" /* yacc.c:1646  */
    {printf("result is %d\n",(yyvsp[-1].a_number));}
#line 1231 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 25 "calcy.y" /* yacc.c:1646  */
    {(yyval.a_number) = (yyvsp[0].a_number);}
